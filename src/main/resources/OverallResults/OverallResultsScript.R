...
MN_10_02 <- read.csv("MN_rawResults_graphColor10Node2_30Values_NP.txt", header = FALSE, sep = "")
...
IC_10_02 <- read.csv("IC_rawResults_graphColor10Node2_30Values_NP.txt", header = FALSE, sep = "")
...
I_10_02 <- read.csv("I_rawResults_graphColor10Node2_30Values_NP.txt", header = FALSE, sep = "")
